  ...
  72  0004               L73:
  73                     ; 61     for(i=0;i<100;i++)
  75  0004 0f01          	clr	(OFST-1,sp)
  76  0006               L54:
  77                     ; 62     for(j=0;j<50;j++);
 ...
 238                     ; 93 	if(GPIO_ReadInputData(GPIOD) & 0x04)	slave_address |= 0x08;
 ...
 248  007a               L101:
 249                     ; 94 	if(GPIO_ReadInputData(GPIOC) & 0x20)	slave_address |= 0x04;
 ...
 259  0088               L301:
 260                     ; 95 	if(GPIO_ReadInputData(GPIOC) & 0x40)	slave_address |= 0x02;
 ...
 270  0096               L501:
 271                     ; 96 	if(GPIO_ReadInputData(GPIOC) & 0x80)	slave_address |= 0x01;
 ...
 400                     ; 159 void assert_failed(uint8_t* file, uint32_t line)
 400                     ; 160 { 
